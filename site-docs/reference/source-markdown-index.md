...
This index links the documents this wiki synthesizes.

## Primary product and architecture docs

- [README.md](https://github.com/your-org/Edgecoder/blob/main/README.md)
- [README.dev.md](https://github.com/your-org/Edgecoder/blob/main/README.dev.md)
- [EDGECODER_PLAN.md](https://github.com/your-org/Edgecoder/blob/main/EDGECODER_PLAN.md)
...
- [macOS Installer](https://github.com/your-org/Edgecoder/blob/main/docs/macos-installer.md)
...
- [ADR 0001 Locked Decisions](https://github.com/your-org/Edgecoder/blob/main/docs/adrs/0001-locked-decisions.md)

## Docs infrastructure

- [Docs Site Deployment](https://github.com/your-org/Edgecoder/blob/main/docs/docs-site-deployment.md)
