...
struct AppConfig {
    ...
    static let local = AppConfig(
        environment: .local,
        portalBaseURL: URL(string: "http://10.10.128.195:4301")!,
        controlPlaneBaseURL: URL(string: "http://10.10.128.195:4301")!,
        coordinatorBootstrapURL: URL(string: "http://10.10.128.195:4301")!,
        relyingPartyId: "localhost",
        passkeyOrigin: "http://10.10.128.195:4301"
    )
